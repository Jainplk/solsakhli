...
import layer1 from '../../assets/Image/layer (1).png';
import layer2 from '../../assets/Image/layer (2).png';
import layer3 from '../../assets/Image/layer (3).png';
import layer4 from '../../assets/Image/layer (4).png';

import layer_two_1 from '../../assets/Image/layer_two(2).png';
import layer_two_2 from '../../assets/Image/layer_two(3).png';
import layer_two_3 from '../../assets/Image/layer_two(4).png';
import layer_two_4 from '../../assets/Image/layer_two(5).png';

import layer_three_1 from '../../assets/Image/layer_three(1).png';
import layer_three_2 from '../../assets/Image/layer_three(2).png';
import layer_three_3 from '../../assets/Image/layer_three(3).png';
import layer_three_4 from '../../assets/Image/layer_three(4).png';

import layer_four_1 from '../../assets/Image/layer_four(1).png';
import layer_four_2 from '../../assets/Image/layer_four(2).png';
import layer_four_3 from '../../assets/Image/layer_four(3).png';
import layer_four_4 from '../../assets/Image/layer_four(4).png';

import "./BusinessPlansCommon.css";
import NewSmallComponent from '../UpdatedSection/NewSmallComponent';
...
export default function SmallBusinessSection() {
  ...
  const images = [layer1, layer2, layer3, layer4]

  const images_two = [layer_two_1, layer_two_2, layer_two_3, layer_two_4] 

  const images_three = [layer_three_1, layer_three_2, layer_three_3, layer_three_4]

  const images_four = [layer_four_1, layer_four_2, layer_four_3, layer_four_4]
    ...
    >
      ...
      <div className="relative z-10">
        ...
        {/* <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div
            className="rounded-2xl h-[450px] overflow-hidden group relative business-image-container"
            style={{
          ...
          >
            ...
            {/* Marquee Images */}
            {/* <div className="absolute inset-0 flex flex-col gap-4 items-center overflow-hidden">
              <Marquee speed={50} gradient={false} pauseOnHover className="h-full">
                {images.map((img, i) => (
                  <img key={i} src={img} className="w-[164px] h-auto  mx-4 rounded-xl shadow-xl" />
                ))}
              </Marquee>

              <Marquee speed={50} direction="right" gradient={false}  pauseOnHover className="h-full">
                {images_two.map((img, i) => (
                  <img key={i} src={img} className="w-[164px] h-[100px] mx-4 rounded-xl shadow-xl" />
                ))}
              </Marquee>
              <Marquee speed={50} gradient={false} pauseOnHover className="h-full">
                {images_three.map((img, i) => (
                  <img key={i} src={img} className="w-[164px] h-auto mx-4 rounded-xl shadow-xl" />
                ))}
              </Marquee>
              <Marquee speed={50} direction="right" gradient={false}  pauseOnHover className="h-full">
                {images_four.map((img, i) => (
                  <img key={i} src={img} className="w-[164px] h-[100px] mx-4 rounded-xl shadow-xl" />
                ))}
              </Marquee>
            ...
            {/* Gradient Overlay */}
            {/* <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a]/90 via-[#0a0a0a]/50 to-transparent pointer-events-none" /> */}

            {/* Hover Glow */}
            {/* <div className="absolute inset-0 bg-[#FA8826]/0 group-hover:bg-[#FA8826]/10 transition-all duration-500 pointer-events-none" /> */}

            {/* Border */}
            {/* <div className="absolute inset-0 border border-[#2a2a2a] group-hover:border-[#FA8826]/40 transition-all duration-500 rounded-2xl pointer-events-none" /> */}

            {/* Floating Elements */}
            {/* <div className="absolute top-4 left-4 w-8 h-8 border border-[#FA8826]/30 rounded-full business-float-element pointer-events-none" />
            <div className="absolute bottom-4 right-4 w-6 h-6 border border-[#FA8826]/20 rounded-full business-float-element pointer-events-none" style={{ animationDelay: '0.5s' }} />
