...
import img from '../../assets/Image/image 515.png';
import img1 from '../../assets/Image/image 516.png';
import img2 from '../../assets/Image/image 518.png';
import "./BusinessPlansCommon.css";
// import ImageSlider from '../FramerMotion/ImageSlider';
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="grid lg:grid-cols-2 items-start">
          ...
          <div
            className="rounded-2xl w-full h-[400px] group relative agencies-image-container order-1 lg:order-2 flex items-center justify-center">
            {/* <BounceCards
           ...
           <div className="absolute inset-0 flex items-center overflow-hidden">
              <Marquee speed={50} direction="up" gradient={false} pauseOnHover className="h-full  overflow-hidden">
                <img src={img} className="w-[180px] h-autorounded-xl shadow-xl" />
              </Marquee>

              <Marquee speed={50} direction="down" gradient={false} pauseOnHover className="h-full  overflow-hidden">
                <img src={img1} className="w-[180px] h-auto rounded-xl shadow-xl" />
              </Marquee>

              <Marquee speed={50} direction="up" gradient={false} pauseOnHover className="h-full  overflow-hidden">
                <img src={img2} className="w-[180px] h-auto rounded-xl shadow-xl" />
              </Marquee>
            </div>
          </div>
