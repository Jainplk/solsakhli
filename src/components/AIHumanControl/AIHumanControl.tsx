  ...
  return (
    <section ref={sectionRef} className="ai-human-control">
      <div className="ai-human-control__container">
        ...
        >
          <span className="ai-human-control__title-ai">AI</span> + Human Control
        </h1>
        ...
        >
          <button className="ai-human-control__btn ai-human-control__btn--primary">
            Get Started Today
          </button>
          <button className="ai-human-control__btn ai-human-control__btn--secondary">
            Book a Demo
          </button>
        </div>
      </div>
